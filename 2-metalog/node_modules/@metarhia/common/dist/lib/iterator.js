...
var _marked =
/*#__PURE__*/
regeneratorRuntime.mark(rangeGenerator);
...
function (_Iterator2) {
  ...
  _createClass(FilterIterator, [{
    ...
    value: function next() {
      ...
      try {
        for (var _iterator9 = this.base[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
...
function (_Iterator7) {
  ...
  _createClass(ZipIterator, [{
    ...
    value: function next() {
      ...
      try {
        for (var _iterator10 = this.iterators[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
...
/*#__PURE__*/
function (_Iterator8) {
  _inherits(ChainIterator, _Iterator8);
  ...
  function ChainIterator(base, iterators) {
    ...
    _this8 = _possibleConstructorReturn(this, _getPrototypeOf(ChainIterator).call(this, base));
